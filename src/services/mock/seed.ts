...
export const mockSessions: WorkoutSession[] = [
  ...
  {
    id: 'session-2026-08-14-pm', userId: mockUser.id, routineId: 'push-day', routineName: 'Push Day', status: 'completed',
    startedAt: '2026-08-14T14:30:00.000+09:00', completedAt: '2026-08-14T15:20:00.000+09:00', notes: null,
    exercises: [
      {
        ...
        ].map(([weightKg, reps, actualRir], index) => ({ id: `session2-bench-${index + 1}`, setOrder: index + 1, setType: 'working', weightKg, reps, targetRir: 2, actualRir, restSeconds: 120, isCompleted: true, completedAt: `2026-08-14T14:${40 + index * 4}:00.000+09:00`, notes: null })),
      },
    ],
    createdAt: '2026-08-14T14:30:00.000+09:00', updatedAt: '2026-08-14T15:20:00.000+09:00',
  },
  {
    id: 'session-2026-08-14-eve', userId: mockUser.id, routineId: 'pull-day', routineName: 'Pull Day', status: 'completed',
    startedAt: '2026-08-14T18:00:00.000+09:00', completedAt: '2026-08-14T19:00:00.000+09:00', notes: null,
    exercises: [
      {
        ...
        ].map(([weightKg, reps, actualRir], index) => ({ id: `session3-row-${index + 1}`, setOrder: index + 1, setType: 'working', weightKg, reps, targetRir: 2, actualRir, restSeconds: 120, isCompleted: true, completedAt: `2026-08-14T18:${15 + index * 4}:00.000+09:00`, notes: null })),
      },
    ],
    createdAt: '2026-08-14T18:00:00.000+09:00', updatedAt: '2026-08-14T19:00:00.000+09:00',
  },
]
